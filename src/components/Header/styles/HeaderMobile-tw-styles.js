const styles = {
  navBar: 'navbar w-full bg-greenbg text-white font-Regular',
  ...
  navbarWrapperMobileOpen:
    'w-full nav-mobile slide-in h-screen overflow-y-scroll bg-greenbg text-white flex flex-wrap justify-between content-between',
  navbarWrapperMobile: 'w-full nav-mobile slide-out bg-greenbg text-white',
  menuItem: 'mx-15',
  ...
  wrapper: 'bg-greenbg menu-container mt-10vh overflow-y-auto w-full',
  accordionWrapper: 'mt-40 bg-greenbg menu-main-accordion overflow-auto',
  menuSlotButton:
    'flex text-left w-full font-Regular text-20 text-white px-30 py-25',
}
