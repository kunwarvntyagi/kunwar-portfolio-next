const styles = {
    ...
    navBarWrapper: 'w-full mx-auto flex py-20 px-20 relative',
    headerLogo: 'w-auto h-50',
    ...
    menuItem: 'mx-15 text-black font-Medium',
    menuItemHover: 'mx-15 text-black font-Medium hover-underline-anim',
