export const bannerStyles = {
    ...
    Right: {
        container:
            'RightBanner w-full h-auto py-[5vw] gap-[5vw] flex flex-col-reverse items-center lg:flex-row-reverse bg-bottom',
        contentContainer:
    ...
    Left: {
        container:
            'LeftBanner w-full h-auto py-[5vw] gap-[5vw] flex flex-col-reverse items-center lg:flex-row bg-bottom',
        contentContainer:
            'w-full lg:w-1/2 flex flex-col justify-center items-center',
        imageContainer: 'w-1/2 flex justify-center items-center',
        image: 'w-full lg:w-1/2 m-auto',
